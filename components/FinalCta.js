  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="p-10 sm:p-16 rounded-3xl gradient-bg-primary border border-light glow-indigo space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-accent-soft border border-light text-accent text-xs font-mono">
            <span>One person. One identity. One link.</span>
          </div>
          ...
          <p className="text-base text-secondary max-w-xl mx-auto">
            Join developers, designers, and innovators presenting their digital presence with unparalleled elegance.
          </p>

    ...
    <div className="flex flex-col min-h-screen bg-surface-page text-primary selection:bg-accent-soft selection:text-primary">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-cyan-soft border border-light text-cyan text-xs font-mono">
          ...
          <p className="text-sm sm:text-base text-secondary">
            Discovered nearby OneMe members. Tap on any peer to initiate a secure mutual exchange session.
          </p>
        </div>

        <div className="p-8 sm:p-12 rounded-3xl bg-glass border border-subtle backdrop-blur-xl shadow-2xl space-y-8">
          <RadarScan
            isSearching={true}
            peers={NEARBY_PEERS}
          ...
          <div className="space-y-3 max-w-lg mx-auto">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-secondary font-mono text-center">

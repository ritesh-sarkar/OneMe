...
export function Button({
  ...
  const variants = {
    primary: "btn-primary focus:ring-accent active:scale-[0.98]",
    secondary: "btn-secondary focus:ring-accent active:scale-[0.98]",
    outline: "btn-outline focus:ring-accent active:scale-[0.98]",

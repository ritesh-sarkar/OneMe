export const DEMO_USER = {
  ...
  socials: [
    { id: 'soc_1', platform: 'github', label: 'GitHub', url: 'https://github.com/riteshsarkar', handle: '@riteshsarkar', icon: 'FiGithub', featured: true },
    { id: 'soc_2', platform: 'linkedin', label: 'LinkedIn', url: 'https://linkedin.com/in/riteshsarkar', handle: 'in/riteshsarkar', icon: 'FiLinkedin', featured: true },
    { id: 'soc_3', platform: 'x', label: 'X (Twitter)', url: 'https://x.com/riteshsarkar', handle: '@riteshsarkar', icon: 'FiTwitter', featured: true },
    { id: 'soc_4', platform: 'facebook', label: 'Facebook', url: 'https://facebook.com/ritesh.sarkar', handle: 'ritesh.sarkar', icon: 'FiFacebook', featured: false },
    { id: 'soc_5', platform: 'instagram', label: 'Instagram', url: 'https://instagram.com/ritesh.codes', handle: '@ritesh.codes', icon: 'FiInstagram', featured: false },
    { id: 'soc_6', platform: 'whatsapp', label: 'WhatsApp', url: 'https://wa.me/8801712345678', handle: '+880 1712-345678', icon: 'FaWhatsapp', featured: true }
  ],
  customCta: {
    enabled: true,
    text: 'Hire Me for Projects',
    subtitle: 'Available for freelance & full-time roles',
    url: 'mailto:ritesh@sarkar.dev?subject=Project%20Inquiry%20from%20OneMe',
...
export const DEMO_PROJECTS = [
  {
    ...
    description: 'An ultra-fast real-time telemetry and web analytics visualization platform built for high-throughput metrics tracking and anomaly detection.',
    technologies: ['Next.js', 'React', 'Tailwind CSS', 'Node.js', 'WebSockets', 'Chart.js'],
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800',
    githubUrl: 'https://github.com/riteshsarkar/pulseflow-analytics',
    liveUrl: 'https://pulseflow.demo.app',
    status: 'Live & Active',
    featured: true,
  ...
  },
  {
    ...
    description: 'An open-source, accessible, and themeable React UI library engineered with Framer Motion transitions, responsive tokens, and micro-interactions.',
    technologies: ['React', 'Tailwind CSS', 'Framer Motion', 'Radix UI', 'JavaScript'],
    image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&q=80&w=800',
    githubUrl: 'https://github.com/riteshsarkar/hypercraft-ui',
    liveUrl: 'https://hypercraft.demo.design',
    status: 'V2 Released',
    featured: true,
  ...
  },
  {
    ...
    description: 'A seamless browser-based document collaboration tool supporting live multi-cursor synchronization, Markdown rendering, and encrypted file sharing.',
    technologies: ['Next.js', 'Express', 'MongoDB', 'Socket.io', 'Tailwind CSS'],
    image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800',
    githubUrl: 'https://github.com/riteshsarkar/nexussync-workspace',
    liveUrl: 'https://nexussync.demo.app',
...
export const DEMO_EXPERIENCE = [
  {
    ...
    period: '2023 — Present',
    description: 'Architecting high-performance web applications, interactive dashboards, and design systems for enterprise SaaS clients across Europe and Asia.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Dhaka, Bangladesh',
    period: '2021 — 2023',
    description: 'Developed RESTful backend services and intuitive frontend interfaces using React, Node.js, Express, and MongoDB.',
    highlights: [
...
export const DEMO_EDUCATION = [
  {
    ...
    description: 'Specialized in Software Engineering, Distributed Systems, Algorithm Design, and Web Architectures. Head of Tech at Student ACM Chapter.'
  }
];
...
export const DEMO_CERTIFICATIONS = [
  {
    ...
    verifyUrl: 'https://coursera.org/verify/professional-cert/META-FE-88921',
...
export const DEMO_ACHIEVEMENTS = [
  {
    ...
    date: 'Dec 2023',
    description: 'Built an AI-powered emergency logistics coordination platform within 36 hours among 120 participating teams.'
  },
  {
    id: 'ach_2',
    ...
    date: 'Oct 2023',
    description: 'Contributed 45+ merged pull requests to major JavaScript developer tools and accessibility packages.'
  },
  {
    id: 'ach_3',
    ...
    date: 'May 2022',
    description: 'Awarded for consecutive top 1% academic merit in Computer Science & Engineering department.'
  }
];

export const DEMO_RESUME = {
  fileName: 'Ritesh_Sarkar_FullStack_Resume.pdf',
  fileSize: '1.4 MB',
  updatedAt: '2026-08-15',
  summary: 'Full-Stack Developer with 4+ years of professional experience building scalable, high-performance web applications using React, Next.js, Node.js, and modern cloud technologies. Proven track record in frontend architecture, design systems, and developer tooling.',
  downloadCount: 428
};
...
export const DEMO_ANALYTICS = {
  ...
  trafficSources: [
    { source: 'Direct & QR Code', count: 520, percentage: 40.5, color: '#6366f1' },
    { source: 'LinkedIn', count: 395, percentage: 30.7, color: '#0ea5e9' },
    { source: 'GitHub Profile', count: 210, percentage: 16.4, color: '#10b981' },
    { source: 'X / Twitter', count: 115, percentage: 8.9, color: '#f59e0b' },
    { source: 'Other / Referrals', count: 44, percentage: 3.5, color: '#ec4899' }
  ],
  topClickedLinks: [
    { label: 'GitHub Profile', clicks: 84, url: 'https://github.com/riteshsarkar' },
    { label: 'PulseFlow Live Demo', clicks: 52, url: 'https://pulseflow.demo.app' },
    { label: 'Download Resume (.pdf)', clicks: 46, url: '#resume' },
    { label: 'LinkedIn Connection', clicks: 38, url: 'https://linkedin.com/in/riteshsarkar' },
    { label: 'HyperCraft UI Repo', clicks: 27, url: 'https://github.com/riteshsarkar/hypercraft-ui' }
  ],
  devices: [
...
export const DEMO_CONNECTIONS = [
  {
    ...
    phone: '+65 9123 4567',
    notes: 'Met at Design & Code Summit 2026. Interested in collaborating on design system components.'
  },
  {
    id: 'conn_2',
    name: 'John Doe',
    ...
    notes: 'Connected via OneMe QR at WebConf. Shared insights on payment processing microservices.'
  },
  {
    id: 'conn_3',
    name: 'Alex Rivera',
    ...
    notes: 'Exchanged contact info at AI Founders Meetup. Looking for senior frontend consulting.'
  },
  {
    id: 'conn_4',
    name: 'Maya Patel',
    ...
    notes: 'Connected on Next.js Conf. Recommended my PulseFlow project for developer showcase.'
  }
];
...
export const DEMO_NOTIFICATIONS = [
  {
    ...
    message: 'Sarah Khan accepted your contact exchange request via OneMe Flow.',
    time: '2 hours ago',
    read: false,
    icon: 'FiUserCheck',
  ...
  },
  {
    ...
    message: 'Your profile QR was scanned 18 times today at a local tech meetup.',
    time: '2 days ago',
    read: true,
    icon: 'FiGrid',
    actionUrl: '/dashboard/analytics'
